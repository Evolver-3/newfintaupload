...
const Footer = () => {
  ...
  return (
    ...
    <div className='flex flex-col gap-15 mt-15'>
      ...
      <div className='bg-neutral-900 rounded-xl flex flex-col items-center justify-center h-90'>


      <div className='flex flex-col items-center justify-center gap-8'>
        <div className='text-[40px] text-center leading-tight font-semibold '>
          <h2 className='text-neutral-200'>Set up in 10 mins. </h2>
        ...
        <p className='text-md text-neutral-400'>Built for founders who want to focus on their business, not their accounting.</p>
      ...
      <div className='flex items-center justify-between '>
        ...
        <div className='flex gap-3'>
          ...
          <p className='text-sm text-neutral-900'>Magically simplify accounting and taxes.</p>
        </div>
      ...
      <div className='flex items-center justify-between'>
       ...
       <p className='text-sm text-neutral-500'> Copyright © Finta Platform Inc. All rights reserved.</p>

       <div className='flex gap-7 text-sm text-neutral-700 cursor-pointer'>
