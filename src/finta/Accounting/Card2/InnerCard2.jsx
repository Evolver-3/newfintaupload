    ...
    <div className='shadow-finta px-5 py-4 rounded-md flex flex-col gap-5 w-full'>
      <div className='flex flex-col gap-2 w-full'>
        ...
        <div className='flex gap-5'>
          <div className='w-auto  rounded-md px-3 relative  ring-1 ring-black/10 ring-inset shadow-weird'>
            <svg
            className='absolute  inset-0 bg-blue-600 w-full rounded-md text-white text-xl h-full '  xmlns="http://www.w3.org/2000/svg" width="24" height="24"  
...
<path d="M9 15.59 4.71 11.3 3.3 12.71l5 5c.2.2.45.29.71.29s.51-.1.71-.29l11-11-1.41-1.41L9.02 15.59Z"></path>
        ...
        <div className='flex gap-2 justify-between w-full items-center'>
          <div className='bg-blue-600 text-white text-sm font-semibold px-15 py-1.5 rounded-md'>Categorize all</div>
          <div className='flex gap-1   items-center text-sm shadow-finta px-1 py-1 rounded-md justify-around'>
            No<span className=' ring-1 ring-black/10 ring-inset shadow-weird text-sm px-1 py-1 rounded-md'>Esc</span>
          </div>
        </div>
      </div>
